...
yfinance imposed limits on information that could be fetched on the date of submission. This resulted in my code throwing errors if a limit was reached and halting the program. As a result, I had to generate a csv version of my fundamentals data for the dow jones that the program could fall back to if it could not fetch financials information. 
